...
async def account_markup(user_id: int) -> types.InlineKeyboardMarkup | None:
    ...
    if customer:
        # if customer['activated']:
            keyboard_markup.inline_keyboard[1].append(types.InlineKeyboardButton(text = "📢ТРИВОГА📢", callback_data = "alarm"))
        # else:
            # keyboard_markup.inline_keyboard[1].append(types.InlineKeyboardButton(text = "Отримати доступ до Охорони", callback_data = "get_guard_access"))
...
def alarm_reasons_markup() -> types.InlineKeyboardMarkup:
    keyboard_markup = types.InlineKeyboardMarkup(inline_keyboard = [
            [
                types.InlineKeyboardButton(text = "Побутова сварка", callback_data = "Побутова сварка"),
                types.InlineKeyboardButton(text = "Конфлікт на дорозі", callback_data = "онфлікт на дорозі"),
            ],
            [
                types.InlineKeyboardButton(text = "Розбій", callback_data = "Розбій"),
                types.InlineKeyboardButton(text = "Сімейна сварка", callback_data = "Сімейна сварка")
            ]
        ]
    )
    return keyboard_markup
